...
export const translations = {
  en: {
    ...
    staySignedInPrompt: "Stay signed in on this device?",
    staySignedInDescription: "Stay signed in on this device so you don't have to input your credentials again when visiting next time.",
    yesStaySignedIn: "Yes, stay signed in",
    noThanks: "No, thanks",
  ...
  hi: {
    ...
    dontHaveAccountLink: "खाता नहीं है? नया बनाएं",
    staySignedInPrompt: "क्या आप इस डिवाइस पर लॉग इन रहना चाहते हैं?",
    staySignedInDescription: "इस डिवाइस पर साइन इन रहें ताकि अगली बार आने पर आपको अपने क्रेडेंशियल दोबारा दर्ज न करने पड़ें।",
    yesStaySignedIn: "हाँ, लॉग इन रहें",
    ...
    profileSavedSuccess: "लॉगिन सफल! पुनर्निर्देशित किया जा रहा है...",
  ...
  ta: {
    ...
    dontHaveAccountLink: "கணக்கு இல்லையா? புதிதாக உருவாக்கு",
    staySignedInPrompt: "இந்த சாதனத்தில் தொடர்ந்து உள்நுழைந்திருக்க விரும்புகிறீர்களா?",
    staySignedInDescription: "அடுத்த முறை வரும்போது உங்கள் விவரங்களை மீண்டும் உள்ளிட வேண்டியதில்லை என்பதற்காக இந்த சாதனத்தில் தொடர்ந்து உள்நுழைந்திருக்கவும்.",
    yesStaySignedIn: "ஆம், உள்நுழைந்திருக்கவும்",
    noThanks: "இல்லை, வேண்டாம்",
    ...
    profileSavedSuccess: "உள்நுழைவு வெற்றிகரமானது! திருப்பி அனுப்பப்படுகிறது...",
